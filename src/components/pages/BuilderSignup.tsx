...
import { Building2, Mail, Lock, Phone, User, FileText } from 'lucide-react';
import { supabase } from '../../lib/supabase';
import toast from 'react-hot-toast';

export function BuilderSignup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Account created successfully! Please wait for verification.');
  ...
  return (
    <div className="max-w-md mx-auto">
      <div className="text-center mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900">Create Builder Account</h1>
        <p className="mt-2 text-gray-600">Sign up to showcase your services</p>
      </div>
